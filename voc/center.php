...
?>
		<img id = "indexpic<?php echo $key; ?>" src="<?php echo ($num != 0?'uppics/'.$typevalue['indexpic']:'images/null.jpg'); ?> " width="<?php echo getWidth(($num != 0?'uppics/'.$typevalue['indexpic']:'images/null.jpg'),500,500); ?>" height="<?php echo getHeight(($num != 0?'uppics/'.$typevalue['indexpic']:'images/null.jpg'),500,500); ?>" border="0"/>
<?php
	if($num != 0){
?>	
		</a>
...
?>		</td>
	...
	<tr>
		...
		<td height="25" align="center" valign="middle"><?php echo $typevalue['typename']; ?>( <?php echo $num; ?>&nbsp;张 )&nbsp;
	</tr>
</table>
</td>
