...
<?php
		...
		if($picarr != ''){
?>
<div align="center" style=" width:1348px; height:80px; background-image:url(images/showalb.gif); background-position: center; vertical-align:middle; background-repeat:no-repeat;"></div>
