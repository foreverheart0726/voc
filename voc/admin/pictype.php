<?php
	...
	$conne->close_rst();
?>
<div  align="center" style="background-image:url(../images/centertop.gif); background-position: top; background-repeat:no-repeat; width: 800px; height: 42px; margin:15px;"></div>
<div  align="center" style=" width:805px; border:1px #000000 solid;">
<table id="addtypefm" width="300px" border="0" cellspacing="0" cellpadding="0"  align="center">
  <tr>
...
<table width="400" border="1" cellspacing="0" cellpadding="0" bgcolor="#f7f3e8" align="center">
<?php
...
<div id="modtitle" style=" text-align:center; height: 25px;">修改类别<br /></div>
